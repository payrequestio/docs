...
<Update label="2026-04-30" description="v3.9.1" tags={["Sales Page", "Branding"]}>
## Brand Your Sales Page with a Custom Accent Color

The Sales Page Styling tab now has an **Accent Color** picker. Choose a brand color and it's applied to your "Pay" button, avatar border, and other primary highlights on your public sales page — so visitors see *your* color, not the default blue.
...
- **Per-page setting** — Stored on your sales page, ready to extend per-business in the future

### How It Works

1. Open **Sales Page** from the dashboard and click the **Styling** tab
...
5. Click **Save Styling** — your live sales page picks up the new color on the next visit
...
- **Freelancer support** — Works for businesses with shops and freelancers with sales pages alike
