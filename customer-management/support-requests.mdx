...
description: "Manage customer support tickets with email-to-ticket, rich text replies, file attachments, email notifications, and two-way email conversations"
---
